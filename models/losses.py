...
class CurricularFace(nn.Module):
    """
    CurricularFace - адаптивная margin-based loss функция для распознавания лиц
...
class FocalLoss(nn.Module):
    ...
    Может использоваться в комбинации с CurricularFace
    """
...
if __name__ == "__main__":
    # Тестирование loss функций (CosFace и CurricularFace)
    batch_size = 4
    embedding_size = 128
    num_classes = 1000
